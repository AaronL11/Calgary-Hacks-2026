...
<section className="mx-auto max-w-6xl px-4 pt-12 pb-8">
  <div className="grid gap-10 md:grid-cols-2 items-start">
    ...
    <div>
      <div className="space-y-6">
        <div className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3 py-1 text-xs">
          ...
          <span className="text-neutral-700">Built for academic integrity</span>
        </div>

        <div>
          <h1 className="text-3xl font-semibold tracking-tight md:text-5xl">
            Helping you <span className="text-uofc-red">help yourself</span>
          </h1>
          <p className="mt-3 max-w-xl text-neutral-700 md:text-lg">
            A crowd-sourced archive of exam-style problems and course information designed to preserve
            institutional knowledge without posting real exams.
          </p>
        </div>
    ...
    <div>
      <div className="hidden md:block space-y-6 invisible">
        ...
        <div className="flex flex-wrap gap-3">
          <div className="rounded-xl bg-uofc-red px-5 py-3 text-sm font-medium text-white">Browse Courses</div>
          <div className="rounded-xl border border-neutral-300 bg-white px-5 py-3 text-sm font-medium">Add a Problem</div>
        </div>
      </div>
    </div>
  ...
  <div className="mt-10 rounded-2xl border border-neutral-200 bg-white p-4">
    <p className="text-sm font-medium text-uofc-charcoal">Academic integrity rules</p>
  ...
  <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-4">
    ...
    <p className="mt-1 text-sm text-neutral-600">
      Find courses, topics, professors, or patterns (e.g., "DP", "graph cut", "scheduling").
    </p>
...
<section className="mx-auto max-w-6xl px-4 py-8">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-700">Start with a few course pages, then expand by semester/professor.</p>
          </div>
          <Link className="text-sm font-medium underline underline-offset-4" to="/courses">View all</Link>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12">
        ...
        <p className="mt-1 text-sm text-neutral-700">Highly upvoted reflections + reconstructed problems (not verbatim exams).</p>
          ...
          {TOP.map((s) => (
            <Card key={s._id}>
              <div className="p-5">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {s.tags.map((t) => <TagPill key={t} text={t} />)}
                </div>
